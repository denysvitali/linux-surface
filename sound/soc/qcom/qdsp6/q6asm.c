				     ...
				     int session_id)
{
	...
	case APR_BASIC_RSP_RESULT:
		...
		case ASM_DATA_CMD_WRITE_V2:
			/*
			 * The SPX ADSP returns an acceptance ACK for each write but no
			 * consumption event. Do not translate the immediate ACK into
			 * WRITE_DONE: that queues periods without pacing and overruns
			 * the DSP. q6asm-dai's period watchdog handles this firmware.
			 */
			break;
